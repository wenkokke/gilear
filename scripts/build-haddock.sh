...
if ! ${HADDOCK} \
  ...
  --read-interface=gilear-animate-ast,./doc/reference/gilear-animate-ast/gilear-animate-ast.haddock \
  --read-interface=gilear-w,./doc/reference/gilear-w/gilear-w.haddock; then
  exit 1
fi
